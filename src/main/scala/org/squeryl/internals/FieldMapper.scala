...
trait FieldMapper {
  ...
  private val registry =
    new mutable.HashMap[Class[_], FieldAttributesBasedOnType[_]]
  ...
  protected object PrimitiveTypeSupport {
    ...
    val booleanTEF = new TypedExpressionFactory[Boolean, TBoolean] with PrimitiveJdbcMapper[Boolean] {
      ...
      def extractNativeJdbcValue(rs: ResultSet, i: Int): Boolean =
        rs.getBoolean(i)
    }
    ...
    val optionBooleanTEF =
      ...
      with DeOptionizer[Boolean, Boolean, TBoolean, Option[Boolean], TOptionBoolean] {
        val deOptionizer: TypedExpressionFactory[Boolean, TBoolean] with PrimitiveJdbcMapper[Boolean] {
          val defaultColumnLength: Int
    ...
    with DeOptionizer[UUID, UUID, TUUID, Option[UUID], TOptionUUID] {
      val deOptionizer: TypedExpressionFactory[UUID, TUUID] with PrimitiveJdbcMapper[UUID] {
        val defaultColumnLength: Int
    ...
    val binaryTEF = new TypedExpressionFactory[Array[Byte], TByteArray] with PrimitiveJdbcMapper[Array[Byte]] {
      ...
      def extractNativeJdbcValue(rs: ResultSet, i: Int): Array[Byte] =
        rs.getBytes(i)
    }
    ...
    val optionByteArrayTEF =
      ...
      with DeOptionizer[Array[Byte], Array[Byte], TByteArray, Option[Array[Byte]], TOptionByteArray] {
        val deOptionizer: TypedExpressionFactory[Array[Byte], TByteArray] with PrimitiveJdbcMapper[Array[Byte]] {
          val defaultColumnLength: Int
    ...
    with DeOptionizer[Byte, Byte, TByte, Option[Byte], TOptionByte] {
      ...
      val floatifyer
        : FloatTypedExpressionFactory[Option[Float], TOptionFloat] with DeOptionizer[Float, Float, TFloat, Option[
          Float
        ], TOptionFloat] {
    ...
    val longTEF =
      new IntegralTypedExpressionFactory[Long, TLong, Double, TDouble] with PrimitiveJdbcMapper[Long] {
        ...
        val floatifyer: FloatTypedExpressionFactory[Double, TDouble] with PrimitiveJdbcMapper[Double] {
          val defaultColumnLength: Int
    ...
    with DeOptionizer[Long, Long, TLong, Option[Long], TOptionLong] {
      val deOptionizer: IntegralTypedExpressionFactory[Long, TLong, Double, TDouble] with PrimitiveJdbcMapper[Long] {
        val defaultColumnLength: Int
      ...
      val floatifyer
        : FloatTypedExpressionFactory[Option[Double], TOptionDouble] with DeOptionizer[Double, Double, TDouble, Option[
          Double
        ], TOptionDouble] {
    ...
    val optionFloatTEF =
      ...
      with DeOptionizer[Float, Float, TFloat, Option[Float], TOptionFloat] {
        val deOptionizer: FloatTypedExpressionFactory[Float, TFloat] with PrimitiveJdbcMapper[Float] {
          val defaultColumnLength: Int
    ...
    with DeOptionizer[Double, Double, TDouble, Option[Double], TOptionDouble] {
      val deOptionizer: FloatTypedExpressionFactory[Double, TDouble] with PrimitiveJdbcMapper[Double] {
        val defaultColumnLength: Int
    ...
    val optionBigDecimalTEF =
      ...
      with DeOptionizer[BigDecimal, BigDecimal, TBigDecimal, Option[BigDecimal], TOptionBigDecimal] {
        val deOptionizer: FloatTypedExpressionFactory[BigDecimal, TBigDecimal] with PrimitiveJdbcMapper[BigDecimal] {
          val defaultColumnLength: Int

          val sample: BigDecimal
