...
trait PrimitiveTypeMode extends QueryDsl with FieldMapper {
  ...
  implicit val optionFloatTEF: FloatTypedExpressionFactory[Option[Float], TOptionFloat] with DeOptionizer[
    Float,
    Float,
    TFloat,
    Option[Float],
  ...
  } = PrimitiveTypeSupport.optionFloatTEF
  ...
  implicit val optionDoubleTEF
    ...
    } = PrimitiveTypeSupport.optionDoubleTEF
  ...
  implicit val optionBigDecimalTEF
    : FloatTypedExpressionFactory[Option[BigDecimal], TOptionBigDecimal] with DeOptionizer[
      BigDecimal,
      BigDecimal,
      TBigDecimal,
      Option[BigDecimal],
