...
trait CompositeKey {
  ...
  private[squeryl] var _members: Option[Seq[SelectElementReference[_, _]]] =
    None
...
case class CompositeKey3[A1, A2, A3](a1: A1, a2: A2, a3: A3)(
  ...
  def inTuples(cks: (A1, A2, A3)*): LogicalBoolean =
    inExpr(cks map (ck => CompositeKey3(ck._1, ck._2, ck._3)))

  def notIn(cks: CompositeKey3[A1, A2, A3]*): LogicalBoolean = notInExpr(cks)
  def notInTuples(cks: (A1, A2, A3)*): LogicalBoolean =
    notInExpr(cks map (ck => CompositeKey3(ck._1, ck._2, ck._3)))
...
case class CompositeKey4[A1, A2, A3, A4](a1: A1, a2: A2, a3: A3, a4: A4)(
  ...
  def inTuples(cks: (A1, A2, A3, A4)*): LogicalBoolean =
    inExpr(cks map (ck => CompositeKey4(ck._1, ck._2, ck._3, ck._4)))

  def notIn(cks: CompositeKey4[A1, A2, A3, A4]*): LogicalBoolean =
    notInExpr(cks)
  def notInTuples(cks: (A1, A2, A3, A4)*): LogicalBoolean =
    notInExpr(cks map (ck => CompositeKey4(ck._1, ck._2, ck._3, ck._4)))
...
case class CompositeKey5[A1, A2, A3, A4, A5](a1: A1, a2: A2, a3: A3, a4: A4, a5: A5)(
  ...
  def inTuples(cks: (A1, A2, A3, A4, A5)*): LogicalBoolean =
    inExpr(cks map (ck => CompositeKey5(ck._1, ck._2, ck._3, ck._4, ck._5)))

  def notIn(cks: CompositeKey5[A1, A2, A3, A4, A5]*): LogicalBoolean =
    notInExpr(cks)
  def notInTuples(cks: (A1, A2, A3, A4, A5)*): LogicalBoolean =
    notInExpr(cks map (ck => CompositeKey5(ck._1, ck._2, ck._3, ck._4, ck._5)))
...
case class CompositeKey6[A1, A2, A3, A4, A5, A6](a1: A1, a2: A2, a3: A3, a4: A4, a5: A5, a6: A6)(
  ...
  def inTuples(cks: (A1, A2, A3, A4, A5, A6)*): LogicalBoolean =
    inExpr(cks map (ck => CompositeKey6(ck._1, ck._2, ck._3, ck._4, ck._5, ck._6)))

  def notIn(cks: CompositeKey6[A1, A2, A3, A4, A5, A6]*): LogicalBoolean =
    notInExpr(cks)
  def notInTuples(cks: (A1, A2, A3, A4, A5, A6)*): LogicalBoolean =
    notInExpr(cks map (ck => CompositeKey6(ck._1, ck._2, ck._3, ck._4, ck._5, ck._6)))
...
case class CompositeKey7[A1, A2, A3, A4, A5, A6, A7](a1: A1, a2: A2, a3: A3, a4: A4, a5: A5, a6: A6, a7: A7)(
  ...
  def in(cks: CompositeKey7[A1, A2, A3, A4, A5, A6, A7]*): LogicalBoolean =
    inExpr(cks)
  def inTuples(cks: (A1, A2, A3, A4, A5, A6, A7)*): LogicalBoolean =
    inExpr(cks map (ck => CompositeKey7(ck._1, ck._2, ck._3, ck._4, ck._5, ck._6, ck._7)))

  def notIn(cks: CompositeKey7[A1, A2, A3, A4, A5, A6, A7]*): LogicalBoolean =
    notInExpr(cks)
  def notInTuples(cks: (A1, A2, A3, A4, A5, A6, A7)*): LogicalBoolean =
    notInExpr(cks map (ck => CompositeKey7(ck._1, ck._2, ck._3, ck._4, ck._5, ck._6, ck._7)))
...
case class CompositeKey8[A1, A2, A3, A4, A5, A6, A7, A8](a1: A1, a2: A2, a3: A3, a4: A4, a5: A5, a6: A6, a7: A7, a8: A8)(
  ...
  def in(cks: CompositeKey8[A1, A2, A3, A4, A5, A6, A7, A8]*): LogicalBoolean =
    inExpr(cks)
  def inTuples(cks: (A1, A2, A3, A4, A5, A6, A7, A8)*): LogicalBoolean =
    inExpr(cks map (ck => CompositeKey8(ck._1, ck._2, ck._3, ck._4, ck._5, ck._6, ck._7, ck._8)))

  def notIn(cks: CompositeKey8[A1, A2, A3, A4, A5, A6, A7, A8]*): LogicalBoolean =
    notInExpr(cks)
  def notInTuples(cks: (A1, A2, A3, A4, A5, A6, A7, A8)*): LogicalBoolean =
    notInExpr(cks map (ck => CompositeKey8(ck._1, ck._2, ck._3, ck._4, ck._5, ck._6, ck._7, ck._8)))
...
case class CompositeKey9[A1, A2, A3, A4, A5, A6, A7, A8, A9](
  ...
  def in(cks: CompositeKey9[A1, A2, A3, A4, A5, A6, A7, A8, A9]*): LogicalBoolean =
    inExpr(cks)
  def inTuples(cks: (A1, A2, A3, A4, A5, A6, A7, A8, A9)*): LogicalBoolean =
    inExpr(cks map (ck => CompositeKey9(ck._1, ck._2, ck._3, ck._4, ck._5, ck._6, ck._7, ck._8, ck._9)))

  def notIn(cks: CompositeKey9[A1, A2, A3, A4, A5, A6, A7, A8, A9]*): LogicalBoolean =
    notInExpr(cks)
  def notInTuples(cks: (A1, A2, A3, A4, A5, A6, A7, A8, A9)*): LogicalBoolean =
    notInExpr(cks map (ck => CompositeKey9(ck._1, ck._2, ck._3, ck._4, ck._5, ck._6, ck._7, ck._8, ck._9)))
