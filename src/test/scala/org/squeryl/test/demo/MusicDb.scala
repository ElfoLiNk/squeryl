...
class TestData {
  ...
  val goodOldFunkyMusic: Song =
    theMeters.newSong("Good old Funky Music", None, 1968)
  val funkAndLatinJazz: Playlist =
    playlists.insert(new Playlist("Funk and Latin Jazz", "c:/myPlayLists/funkAndLatinJazz"))
}
